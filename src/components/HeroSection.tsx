        ...
        <AnimatePresence mode="wait">
          <motion.div key={current} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -30 }} transition={{ duration: 0.6 }} className="max-w-3xl">
            ...
            <div className="text-lg sm:text-xl md:text-2xl text-primary font-display font-semibold mb-4 sm:mb-6 h-8">
              <TypedText strings={["Creative Work Idea", "Cutting-edge Technology", "Beautiful Design"]} typeSpeed={60} backSpeed={30} backDelay={2000} />
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <a href="#about-us" className="inline-flex items-center justify-center px-6 sm:px-8 py-3 bg-white text-[hsl(220,30%,10%)] font-semibold rounded-sm hover:bg-white/90 transition-colors text-sm sm:text-base">About Company</a>
              <a href="#contact" className="inline-flex items-center justify-center px-6 sm:px-8 py-3 border-2 border-white/30 text-white font-semibold rounded-sm hover:bg-white/10 transition-colors text-sm sm:text-base">Contact</a>
            </div>
          </motion.div>
        </AnimatePresence>
